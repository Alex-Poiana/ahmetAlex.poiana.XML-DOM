			...
			for ($i=0; $i<$elementi->length; $i++) {
				...
				if ($username==$_POST['selection']){
					...
					if ($ban=="nonAttivo"){
						...
						$elemBan=$elemento->getElementsByTagName("ban")->item(0);
						$newElemBan=$doc->createElement("ban", "attivo");
						$elemento->replaceChild($newElemBan, $elemBan);
			...
			for ($i=0; $i<$elementi->length; $i++) {
				...
				if ($username==$_POST['selection']){
					...
					if ($ban=="attivo"){
						...
						$elemBan=$elemento->getElementsByTagName("ban")->item(0);
						$newElemBan=$doc->createElement("ban", "nonAttivo");
						$elemento->replaceChild($newElemBan, $elemBan);
